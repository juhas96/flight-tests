...
class AllTestsTableViewController: UITableViewController {
    ...
    let allTests: [TestCategory] = [
        ...
        TestCategory(categoryName: "Pravidlá lietania", tests: ["Pravidlá lietania L-2 X56", "Pravidlá lietania L-2 X57", "Pravidlá lietania L-2 X58", "Pravidlá lietania L-2 X59", "Pravidlá lietania L-2 X60", "Pravidlá lietania L-2 X61", "Pravidlá lietania L-2 X62", "Pravidlá lietania L-2 Y56", "Pravidlá lietania L-2 Y57", "Pravidlá lietania L-2 Y58", "Pravidlá lietania L-2 Y59", "Pravidlá lietania L-2 Y60", "Pravidlá lietania L-2 Y61", "Pravidlá lietania L-2 Y62"]),
        TestCategory(categoryName: "Predpis - Prevádzkové služby", tests: ["Predpis o letových prevádzkových službách L-11 X48", "Predpis o letových prevádzkových službách L-11 X49", "Predpis o letových prevádzkových službách L-11 X50", "Predpis o letových prevádzkových službách L-11 X51", "Predpis o letových prevádzkových službách L-11 X52", "Predpis o letových prevádzkových službách L-11 Y48", "Predpis o letových prevádzkových službách L-11 Y49", "Predpis o letových prevádzkových službách L-11 Y50", "Predpis o letových prevádzkových službách L-11 Y51", "Predpis o letových prevádzkových službách L-11 Y52"]),
        TestCategory(categoryName: "Prevádzka Lietadiel", tests: ["Prevádzka lietadiel L-6/II. X53", "Prevádzka lietadiel L-6/II. X54", "Prevádzka lietadiel L-6/II. X55", "Prevádzka lietadiel L-6/II. Y53", "Prevádzka lietadiel L-6/II. Y54", "Prevádzka lietadiel L-6/II. Y55"]),
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return allTests[section].tests.count
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellId, for: indexPath)
        
        let name = self.allTests[indexPath.section].tests[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // TODO: send data
        vc?.testName = allTests[indexPath.section].tests[indexPath.row]
